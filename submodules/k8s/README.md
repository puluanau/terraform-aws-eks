...
| <a name="input_internal_subnets"></a> [internal\_subnets](#input\_internal\_subnets) | Internal subnets to setup with vpc-cni | `list(object({ subnet_id = string, az = string }))` | n/a | yes |
