...
| [aws_vpc_ipv4_cidr_block_association.internal_cidr](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_ipv4_cidr_block_association) | resource |
...
| <a name="input_internal_cidrs"></a> [internal\_cidrs](#input\_internal\_cidrs) | list of cidrs for the internal subnets | `list(string)` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_internal_subnets"></a> [internal\_subnets](#output\_internal\_subnets) | List of internal subnet ID and AZ |
