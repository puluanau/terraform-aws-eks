...
| <a name="input_kms_enabled"></a> [kms\_enabled](#input\_kms\_enabled) | If KMS keys are enabled. If so, prevents applying KMS to EBS volumes. EKS still requires it. | `bool` | n/a | yes |
