...
| <a name="input_compute_namespace"></a> [compute\_namespace](#input\_compute\_namespace) | EKS cluster compute namespace | `string` | `""` | no |
...
| <a name="input_platform_namespace"></a> [platform\_namespace](#input\_platform\_namespace) | EKS cluster platform namespace | `string` | `""` | no |
